      ...
      renderSectionsList () {
        ...
        return (
          <div className='content-slider'>
            <div className='sliderButtonPrev-course' onClick={() => { this.previous()}}></div>
            <Slider  ref={c => this.slider = c } {...settings}>
              { newLessons.map((item, i) =>
                <div key={i}
                  className='lessonButton-course'
                  onClick={() => { this.setState({ lessonDescription: item.description }) }}
                  >{item.name}
                </div> )}
              </Slider>
              <div className='sliderButtonNext-course' onClick={() => { this.next()}}></div>
            </div>
          )
        }
              ...
              <div className='container-course text-center'>
                <div className='row'>
                  <div className='content-course'>
                    <div className='col-xs-12 col-md-12 course-name-course'> {course.name}</div>
